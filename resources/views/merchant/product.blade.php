    ...
    <script>
        ...
        function updateTable(response) {
            ...
            response.data.forEach((product, index) => {
                ...
                actionTd.append(`<button class="btn btn-danger" onclick="deleteData('/products/${product.id}')"><i class="notika-icon notika-trash"></i></button>`);
