...
<head>
    ...
    <style>
        ...
        .notika-address:before {
            font-family: 'FontAwesome', serif;
            content: "\f3c5"; /* Ikon dot-circle-o */
        }

        .notika-username:before {
            font-family: 'FontAwesome', serif;
            content: "\f2bb"; /* Ikon dot-circle-o */
        }

        .notika-key:before {
            font-family: 'FontAwesome', serif;
            content: "\f084"; /* Ikon dot-circle-o */
        }

        .notika-tax:before {
            font-family: 'FontAwesome', serif;
            content: "\f0d6"; /* Ikon dot-circle-o */
        }


        .notika-category:before {
            font-family: 'FontAwesome', serif;
            content: "\f5fd"; /* Ikon dot-circle-o */
        }
