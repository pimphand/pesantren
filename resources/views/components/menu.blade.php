        ...
        <div class="row">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <ul class="nav nav-tabs notika-menu-wrap menu-it-icon-pro text-center text-align" id="menu">
                        ...
                        @else
                            <li><a href="{{route('dashboard')}}"><i class="notika-icon notika-house"></i> Dashboard</a></li>
                            <li><a data-toggle="tab" href="#pengguna"><i class="notika-icon notika-support"></i> Pengguna</a></li>
                            <li><a data-toggle="tab" href="#merchant"><i class="notika-icon notika-edit"></i> Merchant</a></li>
                            <li><a data-toggle="tab" href="#transaksi"><i class="notika-icon notika-bar-chart"></i>Transaksi</a></li>
                            <li><a data-toggle="tab" href="#settings"><i class="notika-icon notika-windows"></i> Pengaturan</a></li>
                        @endif
                    </ul>
